 <p class = "footer-social">
    <a href = "<?php echo get_field( 'facebook_page', 'option' ); ?>" target="_blank" title = "Facebook group"><span class="facebook"></span></a>
    <a href = "<?php echo get_field( 'twitter_page', 'option' ); ?>" target="_blank" title = "Twitter page"><span class="twitter"></span></a>
    ...
    <a href = "<?php echo get_field( 'flickr_page', 'option' ); ?>" target="_blank" title = "Flickr"><span class="flickr"></span></a>
</p>
