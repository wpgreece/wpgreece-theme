            ...
            <div class="text">
                ...
                <div class="row author-box">
                    ...
                    <div class="column-80">
                        ...
                        <a class="share-link twitter" href="<?php $id = get_current_user_id(); get_the_author_meta('twitter', $id); ?>"><img src = "<?php bloginfo ( 'template_url' ) ?>/img/social/twitter.png" alt = "Twitter" /></a>
                        <?php
