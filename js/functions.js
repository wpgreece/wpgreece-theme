jQuery( function ( $ ) {
    ...
    $( '.forum-titles li, .page-container h1, .sidebar-menu li a, .widgettitle, .post-category a, .more-news h2, .read-more, footer h4, #footer-navigation li a, .bbp-breadcrumb p, bbp-breadcrumb-current, #user-submit' ).greekUppercase();
