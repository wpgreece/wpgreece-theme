                ...
                <div class="row author-box">
                    ...
                    <div class="column-80">
                        ...
                        <div class="author-name-details">
                            ...
                            <a href="<?php  echo get_the_author_meta('facebook', $id ); ?>" class="facebook" title="Facebook"><img src = "<?php bloginfo ( 'template_url' ) ?>/img/social/facebook.png" alt = "Βρες με στα Social" /></a>
